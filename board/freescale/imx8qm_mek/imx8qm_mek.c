...
#define LVDS0_ENABLE IMX_GPIO_NR(1, 5)
#define LVDS1_ENABLE IMX_GPIO_NR(1, 11)
...
#define LVDS1_PAD_CTRL 	((3 << PADRING_IFMUX_SHIFT) | (SC_PAD_CONFIG_OUT_IN << PADRING_CONFIG_SHIFT) | (SC_PAD_ISO_OFF << PADRING_LPCONFIG_SHIFT) \
		| (SC_PAD_28FDSOI_DSE_DV_HIGH << PADRING_DSE_SHIFT) |(SC_PAD_28FDSOI_PS_PD << PADRING_PULL_SHIFT))
static iomux_cfg_t lvdsx_pdb[] = {
...
static void board_gpio_init(void)
{
	...
	gpio_request(LVDS0_ENABLE, "lvds0_pdb_enable");
	/* pull down LVDS0_PDB pin, delay 100 ms then pull up
	 * to avoid panel power up timing issue.
	 */
	gpio_direction_output(LVDS0_ENABLE, 0);
	mdelay(100);
	gpio_direction_output(LVDS0_ENABLE, 1);

	gpio_request(LVDS1_ENABLE, "lvds1_pdb_enable");
	/* pull down LVDS1_PDB pin, delay 100 ms then pull up
	 * to avoid panel powerup timing issue.
	 */
	gpio_direction_output(LVDS1_ENABLE, 0);
	mdelay(100);
	gpio_direction_output(LVDS1_ENABLE, 1);
